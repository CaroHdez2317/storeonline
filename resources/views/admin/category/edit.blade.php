	...
	<div class="row justify-content-center">
		<div class="col-md-offset-3 col-md-6">
		    <div class="page-header text-center">
	          <h1 style="color: #000;"><i class="fa fa-user"></i> Editar categoría</h1><hr>
	        </div>
				...
				<div class="page table-cart">
					<form method="POST" action="{{route('category_update', [$category-> id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ $category->description }}" required>
